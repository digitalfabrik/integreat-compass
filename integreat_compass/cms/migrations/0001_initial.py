...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Cost of this offer. Set to zero if the offer is free",
                        verbose_name="cost",
                    ),
                ),
                (
            ...
            options={
                ...
                "permissions": [
                    ("edit_offer_version", "Can change offer version details")
                ],
                "default_permissions": ("change", "delete", "view"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("NON_PROVIT", "non-profit"),
                            ("FOR_PROFIT", "for-profit"),
                            ("EV", "registered association"),
                        ],
                        help_text="Type of the organization",
        ...
        migrations.AddField(
            model_name="offer", name="tags", field=models.ManyToManyField(to="cms.tag")
        ),
        migrations.CreateModel(
            name="Document",
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        storage=django.core.files.storage.FileSystemStorage(
                            location="/home/charlotte/Projekte/integreat-compass/integreat_compass/media"
                        ),
                        upload_to="documents/",
                        validators=[
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "permissions": [
                    ("set_favorite_offer", "Can add and remove favorite offers")
                ],
                "default_permissions": ("change", "delete", "view"),
