...
This job sets up the test coverage reporter for `CodeClimate <https://codeclimate.com/github/digitalfabrik/integreat-compass>`__.
...
This job joins all separate coverage data files generated from the previous steps and uploads it to `CodeClimate <https://codeclimate.com/github/digitalfabrik/integreat-compass>`__.
...
This job publishes the built package to `TestPyPI <https://test.pypi.org/project/integreat-compass/>`__ via :doc:`twine:index`.
